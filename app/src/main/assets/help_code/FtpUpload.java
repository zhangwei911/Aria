...
public class FtpUpload extends Activity {
    ...
    @Upload.onPre
    public void onPre(UploadTask task) {
    ...
    @Upload.onTaskResume
    public void taskResume(UploadTask task) {
        Log.d(TAG, "恢复上传");
    }

    @Upload.onTaskStop
    public void taskStop(UploadTask task) {
        setSpeed("");
        Log.d(TAG, "停止上传");
    }

    @Upload.onTaskCancel
    public void taskCancel(UploadTask task) {
        setSpeed("");
        setFileSize("");
        setProgress(0);
        Log.d(TAG, "删除任务");
    ...
    public void taskRunning(UploadTask task) {
