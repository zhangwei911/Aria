...
public class NormalToAdapter extends AbsRVAdapter<NormalTo, NormalToAdapter.Holder> {
    ...
    @Override
    protected NormalToAdapter.Holder getViewHolder(View convertView, int viewType) {
    ...
    @Override
    protected void bindData(NormalToAdapter.Holder holder, int position, NormalTo item) {
