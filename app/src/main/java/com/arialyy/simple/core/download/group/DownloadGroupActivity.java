...
public class DownloadGroupActivity extends BaseActivity<ActivityDownloadGroupBinding> {
    ...
    void taskWait(DownloadGroupTask task) {
    ...
    protected void onTaskPre(DownloadGroupTask task) {
    ...
    void taskResume(DownloadGroupTask task) {
        L.d(TAG, "group task resume, p = " + task.getPercent());
    }

    @DownloadGroup.onTaskStop()
    void taskStop(DownloadGroupTask task) {
